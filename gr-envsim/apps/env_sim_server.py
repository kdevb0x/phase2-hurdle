...
# Generated: Mon Sep 25 19:17:16 2017
##################################################
...
class env_sim_server(gr.top_block):
    ...
    def __init__(self, config_file='envsim.ini'):
        ...
        self.zmq_base_addr = zmq_base_addr = "tcp://10.169.25.81:"
        ...
        self.envsim_socket_meta_pdu_0_1_2 = envsim.socket_meta_pdu("UDP_SERVER", host, str(port_num_base+5), 40000, False)
        self.envsim_socket_meta_pdu_0_1_1_0 = envsim.socket_meta_pdu("UDP_CLIENT", usrp_ip_list[4], str(port_num_base+4), 40000, False)
        self.envsim_socket_meta_pdu_0_1_1 = envsim.socket_meta_pdu("UDP_SERVER", host, str(port_num_base+4), 40000, False)
        self.envsim_socket_meta_pdu_0_1_0_0 = envsim.socket_meta_pdu("UDP_CLIENT", usrp_ip_list[3], str(port_num_base+3), 40000, False)
        self.envsim_socket_meta_pdu_0_1_0 = envsim.socket_meta_pdu("UDP_SERVER", host, str(port_num_base+3), 40000, False)
        self.envsim_socket_meta_pdu_0_1 = envsim.socket_meta_pdu("UDP_SERVER", host, str(port_num_base+2), 40000, False)
        self.envsim_socket_meta_pdu_0_0_0 = envsim.socket_meta_pdu("UDP_CLIENT", usrp_ip_list[1], str(port_num_base+1), 40000, False)
        self.envsim_socket_meta_pdu_0_0 = envsim.socket_meta_pdu("UDP_SERVER", host, str(port_num_base+1), 40000, False)
        self.envsim_socket_meta_pdu_0 = envsim.socket_meta_pdu("UDP_SERVER", host, str(port_num_base+0), 40000, False)
        self.envsim_envsim_source_0_1_2 = envsim.envsim_source(samp_rate)
        self.envsim_envsim_source_0_1_1 = envsim.envsim_source(samp_rate)
        self.envsim_envsim_source_0_1_0 = envsim.envsim_source(samp_rate)
        self.envsim_envsim_source_0_1 = envsim.envsim_source(samp_rate)
        self.envsim_envsim_source_0_0 = envsim.envsim_source(samp_rate)
        self.envsim_envsim_source_0 = envsim.envsim_source(samp_rate)
        ...
        self.msg_connect((self.envsim_socket_meta_pdu_0, 'pdus'), (self.envsim_envsim_source_0, 'packets'))
        self.msg_connect((self.envsim_socket_meta_pdu_0_0, 'pdus'), (self.envsim_envsim_source_0_0, 'packets'))
        self.msg_connect((self.envsim_socket_meta_pdu_0_1, 'pdus'), (self.envsim_envsim_source_0_1, 'packets'))
        self.msg_connect((self.envsim_socket_meta_pdu_0_1_0, 'pdus'), (self.envsim_envsim_source_0_1_0, 'packets'))
        self.msg_connect((self.envsim_socket_meta_pdu_0_1_1, 'pdus'), (self.envsim_envsim_source_0_1_1, 'packets'))
        self.msg_connect((self.envsim_socket_meta_pdu_0_1_2, 'pdus'), (self.envsim_envsim_source_0_1_2, 'packets'))
        ...
        self.connect((self.envsim_envsim_source_0, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.envsim_envsim_source_0_0, 0), (self.blocks_add_xx_0, 1))
        self.connect((self.envsim_envsim_source_0_1, 0), (self.blocks_add_xx_0, 2))
        self.connect((self.envsim_envsim_source_0_1_0, 0), (self.blocks_add_xx_0, 3))
        self.connect((self.envsim_envsim_source_0_1_1, 0), (self.blocks_add_xx_0, 4))
        self.connect((self.envsim_envsim_source_0_1_2, 0), (self.blocks_add_xx_0, 5))
